...
type EventCategoryItem = { id: number; name: string; code?: string | null; display_order?: number | null };
  ...
  <div className="space-y-4">
    <div>
      ...
      <input
        ...
        placeholder="Ex: Camp, Conférence, Retraite"
        maxLength={255}
...
export default function EventCategoriesPage() {
  return (
    <SettingsCrudPage<EventCategoryItem>
      title="Catégories d'événements"
      description="Types d'événements (Camp, Conférence, Retraite, Évangélisation...)."
      api={eventCategoriesApi}
      addLabel="Ajouter une catégorie"
      editLabel="Modifier la catégorie"
      deleteLabel="Supprimer la catégorie"
      deleteConfirmLabel="Supprimer cette catégorie d'événement ?"
      ...
      extraColumns={[
        { header: "Code", render: (item: EventCategoryItem) => item.code || "—" },
        { header: "Ordre", render: (item: EventCategoryItem) => item.display_order ?? "—" },
      ]}
    />
  );
}
