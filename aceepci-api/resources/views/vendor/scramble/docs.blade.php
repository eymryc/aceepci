...
/>
@php
    $specWithTagGroups = array_merge($spec, [
        'x-tagGroups' => [
            ['name' => 'Authentification', 'tags' => ['Authentification']],
            ['name' => 'Utilisateurs', 'tags' => ['Utilisateurs']],
            ['name' => 'Rôles & Permissions', 'tags' => ['Rôles & Permissions']],
            [
                'name' => 'Paramètres',
                'tags' => [
...
<script>
    (async () => {
        ...
        docs.apiDescriptionDocument = @json($specWithTagGroups);
    })();
</script>
