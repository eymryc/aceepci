...
/**
 * Requête de validation pour la mise à jour d'un verset du jour.
 */
class UpdateDailyVerseRequest extends BaseApiRequest
{
    ...
    {
        return [
            'primary_text' => ['sometimes', 'required', 'string', 'max:2000'],
            'primary_reference' => ['sometimes', 'required', 'string', 'max:100'],
