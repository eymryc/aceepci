...
/**
 * Validation pour la mise à jour d'un niveau de membre.
 */
class UpdateMemberLevelRequest extends BaseApiRequest
{
    ...
    {
        $id = $this->route('member_level')?->id;

        return [
            'value' => ['sometimes', 'required', 'string', 'max:50', Rule::unique('member_levels', 'value')->ignore($id)],
